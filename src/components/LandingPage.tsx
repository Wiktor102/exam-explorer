...
export function LandingPage() {
  return (
    <main className="landing-page">
      ...
      <div className="landing-scroll-mask landing-scroll-mask--top" aria-hidden="true" />
      <div className="landing-scroll-mask landing-scroll-mask--bottom" aria-hidden="true" />
      ...
      <div className="landing-content">
        ...
        <section className="landing-section landing-about" id="o-projekcie" aria-labelledby="about-title">
          <div className="landing-section__heading">
            <h2 id="about-title">Zadania bez szukania</h2>
            <p>
              Arkusz dobrze nadaje się do próbnego egzaminu. Do ćwiczenia konkretnej technologii jest niewygodny.
              Dlatego ten katalog rozbija każdy arkusz na osobne zadania.
            </p>
          </div>

          <div className="landing-difference-grid">
            <article>
              <span className="landing-card-icon"><Blocks size={22} aria-hidden="true" /></span>
              <p className="landing-card-kicker">Podział per zadanie</p>
              <h3>Jedna część, jeden rekord</h3>
              <p>Otwierasz od razu strony zadania, bez przewijania całego arkusza i szukania początku części.</p>
            </article>
            <article>
              <span className="landing-card-icon"><CodeXml size={22} aria-hidden="true" /></span>
              <p className="landing-card-kicker">Kategorie technologii</p>
              <h3>Ćwicz to, czego potrzebujesz</h3>
              <p>Wyszukuj i filtruj zadania według używanych technologii, typu zadania, sesji oraz roku.</p>
            </article>
            <article>
              <span className="landing-card-icon"><FileSearch size={22} aria-hidden="true" /></span>
              <p className="landing-card-kicker">Arkusz nadal pod ręką</p>
              <h3>Treść i zasady oceniania</h3>
              <p>Porównaj zadanie z pełnym arkuszem, plikami źródłowymi i zasadami oceniania, jeśli są dostępne.</p>
            </article>
          </div>
        </section>

        <section className="landing-section landing-data" id="dane" aria-labelledby="data-title">
          <div className="landing-data__copy">
            <h2 id="data-title">Skąd pochodzą materiały?</h2>
            <p>
              Katalog korzysta z publicznych repozytoriów arkuszy INF.03 i INF.04. Zachowuje odnośniki do PDF-ów,
              plików dołączonych do egzaminu i rozwiązań. Opisy zadań służą do wyszukiwania i filtrowania.
            </p>
          </div>

          <div className="landing-source-list" aria-label="Repozytoria z arkuszami">
            {sourceRepositories.map((repository) => (
              <a href={repository.href} target="_blank" rel="noreferrer" key={repository.code}>
                <span>
        ...
        <section className="landing-section landing-open-source" id="github" aria-labelledby="github-title">
          <div>
            <h2 id="github-title">Brakuje arkusza? Coś nie działa? Zgłoś to.</h2>
            <p>
              Kod aplikacji jest otwarty. Możesz sprawdzić, jak powstaje katalog, zaproponować zmianę albo opisać
              błąd w GitHub Issues.
            </p>
          </div>
          <div className="landing-project-links">
            ...
            <a href="https://github.com/Wiktor102/exam-explorer/issues" target="_blank" rel="noreferrer">
      ...
      <footer className="landing-footer">
        ...
        <span>
          ...
          <time dateTime="2026-09-10T05:34:51.055641+00:00">10 września 2026, 05:34 UTC</time>
        </span>
      </footer>
    </main>
  )
